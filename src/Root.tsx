...
import { vibeScreenMeta } from "./vibe-screen/VibeScreen";
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      <Composition
        id={vibeScreenMeta.id}
        component={vibeScreenMeta.component}
        durationInFrames={vibeScreenMeta.durationInFrames}
        fps={vibeScreenMeta.fps}
        width={vibeScreenMeta.width}
        height={vibeScreenMeta.height}
      />
